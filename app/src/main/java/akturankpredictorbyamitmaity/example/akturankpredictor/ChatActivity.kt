    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!userName.equals("")) {
            ...
            chatList.add(
                Pair(
                    Pair("mySelfAMIT", "selfUserID"),
                    "Need admission help? Fill our form, " +
                        "our expert counselors will WhatsApp " +
                        "you and provide free chat support throughout " +
            ...
            chatList.add(
                Pair(
                    Pair("mySelfAMIT", "selfUserID"),
                    "Join our lively Telegram group with " +
                        "college seniors and future students! " +
                        "\uD83D\uDE80 : https://t.me/college_counseling_assistance"
                )
            )
            ...
            if (str.equals("")) {
                ...
                chatList.add(
                    Pair(
                        ...
                        "Need admission help? Fill our form, " +
                            "our expert counselors will WhatsApp " +
                            "you and provide free chat support " +
                            "throughout the college admission " +
                            "process: https://forms.gle/GDgZUTPVmD2vj7RP6"
                    )
                )
                chatList.add(
                    Pair(
